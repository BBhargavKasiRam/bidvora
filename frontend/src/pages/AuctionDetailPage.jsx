      ...
      <div className="lg:col-span-2">
        ...
        >
          <div className="flex items-center gap-4 mb-8">
            <span className="px-4 py-1 bg-gold text-paper text-[10px] uppercase tracking-[0.2em] font-bold">Live Auction</span>
          ...
          <div className="border-t border-ink/10 pt-16">
            <h3 className="text-xs uppercase tracking-[0.3em] font-bold mb-10 flex items-center gap-3">
            ...
            <div className="space-y-6">
              {auction.bids?.map((bid) => (
                <motion.div 
                  ...
                  key={bid.id} 
                  className="flex justify-between items-center p-6 bg-white border border-ink/5 hover:border-gold/30 transition-all shadow-sm"
                >
          ...
          <div className="bg-white border border-ink/10 p-12 shadow-2xl relative overflow-hidden">
            ...
            <div className="mb-12 p-5 bg-paper border border-ink/5 flex items-center justify-between">
              <div className="flex items-center gap-3 text-ink/60">
                ...
                <span className="text-[10px] uppercase tracking-[0.2em] font-bold">Time Remaining</span>
              </div>
              <span className="text-xs font-mono font-bold text-gold">
                {new Date(auction.end_time) > new Date() ? "ACTIVE" : "CLOSED"}
              </span>
            </div>
